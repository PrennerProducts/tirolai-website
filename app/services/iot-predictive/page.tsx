...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title:
      messages['services.iot_predictive.title'] ?? 'IoT & Predictive Solutions',
    description:
      messages['services.iot_predictive.text'] ??
      'Use machine data for predictive maintenance & Industry 4.0.',
  };
}
